...
c_d = 0.5 # coefficient of drag, typically .75 need to check
rho = 1.22 # air density kg/m**3
...
thrust = 500.0 # motor thrust in N
...
c_d_p = 2.59 # drag coefficient for parachute
p_d = 2.5 # diameter of parachute in m
